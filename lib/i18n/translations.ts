  ...
  zh: {
    ...
    about: {
      hero: {
        ...
        description: "我是一个计算机专业出身的程序员，也是Blackboxcv的3D扫描解决方案顾问。我成长于中国南方的一座小城市，自小就对新鲜事物满怀好奇，乐于挑战未知。我热爱语言及其承载的多元文化，享受与不同背景的伙伴携手合作，闲暇时喜欢旅行、阅读，也热衷于瑜伽等各类运动。2024年，我加入Blackboxcv担任营销顾问。我的核心价值观是用我的平台帮助客户解决问题，满足客户需求。我们团队凭借精湛技术屡获荣誉、专利，在技术研发和创新领域稳步前行。我们能为制造业企业提供3D扫描仪设备等测量解决方案，支持定制化。我个人也可为企业决策者及个人提供数字化分析决策选型工具等数字化服务，助力制定营销战略，实现数字化提效（目前还在建设中。。。）期待与您携手，共创商业价值。",
        identity: {
