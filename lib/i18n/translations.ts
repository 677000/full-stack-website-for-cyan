  ...
  zh: {
    ...
    about: {
      hero: {
        ...
        description: "我成长于中国南方的一座小城市，自小就对新鲜事物满怀好奇，乐于挑战未知。我热爱语言及其承载的多元文化，享受与不同背景的伙伴携手合作，闲暇时喜欢旅行、阅读，也热衷于瑜伽等各类运动。大学期间，我攻读信息管理与信息系统专业，课程融合了管理与计算机学科知识。实习时，我在软件公司负责coding迭代；毕业后，投身制造业企业，主导了工厂数据看板、公司官网、小程序销量查询及权限管理系统等数字化项目的开发。2020年，我决心加入阿里巴巴，经过一年业余时间的技术钻研，成功入职，成为Web前端工程师。在阿里，我熟练运用React、Node.js等新技术，掌握了高效工作、时间任务管理、团队协作及大型系统设计等技能，参与过千万级用户体量的大型项目，也参与并完全主导过对内的集团人才系统。如门店系统和内部人才服务管理系统。2024年，为追求更多自由、可能性与挑战，我加入Blackboxcv担任营销顾问。我们团队凭借精湛技术屡获荣誉、专利，在技术研发和创新领域稳步前行。我们能为制造业企业提供3D扫描仪设备等测量解决方案，支持定制化。我个人也可为企业决策者及个人提供网站开发、数字化分析决策选型工具等数字化服务，助力制定营销战略，实现数字化提效。期待与您携手，共创商业价值。 ",
        cta1: "联系我",
        cta2: "了解更多",
      },
      features: {
